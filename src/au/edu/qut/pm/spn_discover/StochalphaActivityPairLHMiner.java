...
public class StochalphaActivityPairLHMiner implements StochasticNetLogMiner {
	...
	public String getReadableID() {
		return "Stochastic Alpha Miner (left handed activity pair)";
	}
	...
	public void run(PluginContext uipc, XLog log, File outputModelFile) throws Exception {
		...
		StochasticAlphaMiner<XEventClass> miner =
				StochasticAlphaMinerFactory.createActivityPairLHSAM(targetClassifier, log, uipc);
