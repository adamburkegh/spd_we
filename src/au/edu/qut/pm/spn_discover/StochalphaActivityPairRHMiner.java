...
public class StochalphaActivityPairRHMiner implements StochasticNetLogMiner {
	...
	public String getReadableID() {
		return "Stochastic Alpha Miner (right handed activity pair)";
	}
	...
	public void run(PluginContext uipc, XLog log, File outputModelFile) throws Exception {
		...
		StochasticAlphaMiner<XEventClass> miner =
				StochasticAlphaMinerFactory.createActivityPairRHSAM(targetClassifier, log, uipc);
