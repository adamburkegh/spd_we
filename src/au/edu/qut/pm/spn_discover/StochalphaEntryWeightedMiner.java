...
public class StochalphaEntryWeightedMiner implements StochasticNetLogMiner {
	...
	public String getReadableID() {
		return "Alpha Miner Classic + Entry Weighted";
	}
	...
	public StochasticNetDescriptor runMiner(PluginContext uipc, XLog log, 
		...
		WeightEstimator estimator = new EntryWeightedEstimator(
