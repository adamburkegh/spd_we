...
public class StochalphaScaledActivityPairMiner implements StochasticNetLogMiner {
	...
	public String getReadableID() {
		return "Stochastic Alpha Miner (mean scaled activity pair)";
	}
	...
	public void run(PluginContext uipc, XLog log, File outputModelFile) throws Exception {
		...
		StochasticAlphaMiner<XEventClass> miner =
				StochasticAlphaMinerFactory.createMeanScaledActivityPairSAM(targetClassifier, log, uipc);
